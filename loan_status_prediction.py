...
Original file is located at
    https://colab.research.google.com/drive/1d96rqy8UG02MaWj03nWCnal01GN7YsWU

# **Loan Status Prediction**
**About Dataset :**
> bold textAmong all industries, insurance domain has the largest use of analytics & data science methods. 
...
loan_dataset = pd.read_csv('/content/drive/MyDrive/Colab Notebooks/Loan Status Prediction/loan_dataset.csv')
